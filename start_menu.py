...
class StartMenu:
    ...
    def menu_run(self):
        ...
        while run:
            ...
            # clicked（會幫忙判斷是不是在框框範圍內）, create frame（會幫忙指出框框範圍） 在下面那個 Buttons class
            for bt in self.buttons:
                bt.create_frame(x, y) #把bt讀到的 self.start_btn...寫進create frame，這裡的 x,y是x, y = pygame.mouse.get_pos()
